...
class SweeperGrid
{
   ...
   */
   ...
   /* Function: auto_open_recursive
      recursively uncovers cells with no bombs adjacent to it
      Objects           Type      Movement      Name 
      ------------------------------------------------------
      row index         int       REC'D         row
      column index      int       REC'D         col
   */
   void auto_open_recursive(int row, int col);

   /* Function: no_bomb
      uncovers no bomb in the first move
      Objects           Type      Movement      Name 
      ------------------------------------------------------
      row index         int       REC'D         row
      column index      int       REC'D         col
   */
   void no_bomb(int row, int col);
