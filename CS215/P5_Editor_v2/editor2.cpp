// File: editor2.cpp
// Text manipulator(implemented with doubly linked lists)
//
// -------------------------------------------------------
...
#include "document2.h"  // class Document definitions
...
int main(int argc, char * argv[])
{
   ...
   do
   {
	 ...
	 {
	    cerr << "Warning: Document Empty" << endl;
	 }
	 else
	 {
	 ...
	 {
	    cerr << "Error: Cannot open output file" << endl << endl;
	 }
	 else
	 {
	 ...
	 {
	    cerr << "Error: Cannot open input file" << endl << endl;
	 }
	 else
	 {
